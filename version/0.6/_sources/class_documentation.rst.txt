...
The PyEnSight API is described in this section. Much of it is autogenerated and
shared with EnSight.
...
property on the :class:`ansys.pyensight.core.Session` class. Thus, an EnSight call like
