...
class ProcessAPI:
    ...
    def _process_class(self, node: ElementTree.Element, indent: str = "") -> str:
        ...
        with open(pathname, "w", encoding="utf-8") as fp:
            fp.write(s)
        return f"from ansys.pyensight.core.{classname.lower()} import {classname}\n"
    ...
    def process(self, dirname: str, filename: str) -> None:
        ...
        s += '"""\n'
        s += "from ansys.pyensight.core import Session\n"
        s += "from ansys.pyensight.core.ensobj import ENSOBJ\n"
        s += "from ansys.pyensight.core import ensobjlist\n"
        s += "ENSIMPORTS"
...
def generate_stub_api() -> None:
    ...
    sys.path.append("../src")
    from ansys.pyensight.core._version import DEFAULT_ANSYS_VERSION, VERSION
